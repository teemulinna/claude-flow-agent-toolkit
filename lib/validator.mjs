...
export class AgentValidator {
    ...
    async validateAll() {
        ...
        try {
            ...
            throw new Error(`No agents directory found at ${this.agentsDir}`);
        }
        ...
        if (allFiles.length === 0) {
            throw new Error('No agents found in the directory');
        }
    ...
    validateConfig(agentData) {
        ...
        if ('tools' in agentData) {
            ...
            if (Array.isArray(tools)) {
                // Allow array format for backward compatibility
            } else if (typeof tools !== 'object') {
                errors.push("'tools' must be an object or array");
            } else {
